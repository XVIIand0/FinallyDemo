...
try{
									...
									try{
										...
										rs = con.createStatement().executeQuery(sql);
										rs.next();	
										String xd = rs.getString("g_sales");
										int sales = Integer.valueOf(xd).intValue();
										sql = "UPDATE good set g_sales ="+(sales+each_quantity[i])+" WHERE g_id = "+each_gid[i]+" ;";
